...
/*
 * Create new split with mandatory Solana payment
 *
 * POST /api/groups/:group_id/splits
 *
 * @param accessToken The bearer token for authentication
 * @param groupId The ID of the group to create the split in
 * @param body The split data including description, amounts, participants and signed transaction
